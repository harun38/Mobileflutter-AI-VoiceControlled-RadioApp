...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton(
        "ece90fe30916ae0573da733e7a7cc8612e956eca572e1d8b807a3e2338fdd0dc/stage",
      ...
      body: Stack(
        children: [
          ...
          [
            ...
            "Say- Hey Alan 👇".text.italic.semiBold.white.make(),
            10.heightBox,
                      ...
                      [
                        ...
                        Align(
                            ...
                            child: [
                              ...
                              10.heightBox,
                              "Double click to play".text.gray200.make(),
                            ].vStack())
                      ],
                    ))
                        .clip(Clip.antiAlias)
